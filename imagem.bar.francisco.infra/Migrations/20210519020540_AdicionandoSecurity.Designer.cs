...
namespace imagem.bar.francisco.infra.Migrations
{
    ...
    [Migration("20210519020540_AdicionandoSecurity")]
    partial class AdicionandoSecurity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.Despesa", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixa", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixaDespesa", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixaReceita", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.Receita", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Seguranca.AutorizacaoApi", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.Despesa", b =>
                {
                    b.HasOne("imagem.bar.francisco.domain.DTO.Util.Competencia", "Competencia")
                        .WithMany("Despesas")
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixaDespesa", b =>
                {
                    b.HasOne("imagem.bar.francisco.domain.DTO.Account.Despesa", "Despesa")
                        .WithMany("FluxoDeCaixasDespesas")
                        .HasForeignKey("DespesaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixa", "FluxoDeCaixa")
                        .WithMany("FluxoDeCaixasDespesas")
            ...
            modelBuilder.Entity("imagem.bar.francisco.domain.DTO.Account.FluxoDeCaixaReceita", b =>
                {
                    ...
                    b.HasOne("imagem.bar.francisco.domain.DTO.Account.Receita", "Receita")
                        .WithMany("FluxoDeCaixasReceitas")
