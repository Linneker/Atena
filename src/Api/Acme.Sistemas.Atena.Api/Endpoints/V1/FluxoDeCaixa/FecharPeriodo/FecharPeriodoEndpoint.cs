...
public sealed class FecharPeriodoEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            return Results.Created($"/api/v1/fluxo-de-caixa/fechamentos/{response.Id}", response);
        })
        .RequireAuthorization()
        .WithTags("FluxoDeCaixa")
        .WithName("FecharPeriodo")
        .Produces<FecharPeriodoResponse>(StatusCodes.Status201Created)
