...
public sealed class CompensarHorasEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/v1/rh/banco-horas/compensar", async (
            CompensarHorasRequest request, IMediator mediator, CancellationToken cancellationToken) =>
        {
        ...
        .WithName("CompensarHoras")
        .Produces<CompensarHorasResponse>(StatusCodes.Status201Created)
