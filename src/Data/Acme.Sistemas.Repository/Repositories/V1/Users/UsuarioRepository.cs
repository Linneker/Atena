...
public sealed class UsuarioRepository : IUsuarioRepository
{
    ...
    public Task AddAsync(Usuario u, CancellationToken cancellationToken = default)
        => _db.ExecuteAsync(
            @"INSERT INTO usuarios (id, tenant_id, nome_completo, email, password_hash, status, created_at, created_by)
              VALUES (@id, @tenant_id, @nome, @email, @hash, @status, @created_at, @created_by)",
