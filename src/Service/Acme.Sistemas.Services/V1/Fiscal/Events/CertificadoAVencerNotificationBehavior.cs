...
/// <summary>
/// Behavior específico do CertificadoAVencerNotification. Notification não tem pipeline genérico
...
/// </summary>
public static class CertificadoAVencerNotificationBehavior
{
