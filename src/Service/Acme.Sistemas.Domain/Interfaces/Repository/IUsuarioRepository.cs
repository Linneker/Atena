...
public interface IUsuarioRepository
{
    ...
    Task<Usuario?> GetByConfirmationTokenAsync(string tokenHash, CancellationToken cancellationToken = default);
    ...
    Task SetEmailConfirmationTokenAsync(Guid id, string tokenHash, DateTime expiresAt, CancellationToken cancellationToken = default);
    Task ConfirmEmailAsync(Guid id, DateTime confirmedAt, CancellationToken cancellationToken = default);
